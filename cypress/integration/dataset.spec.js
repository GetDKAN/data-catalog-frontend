context('Dataset', () => {
 ...
 beforeEach(() => {
    ...
    it('I see the file is available to download', () => {
      ...
      cy.get('.resource > a').should('have.attr', 'href', 'http://dkan/sites/default/files/distribution/5dc1cfcf-8028-476c-a020-f58ec6dd621c/data_0_2.csv')
    })
    ...
    it.skip('I see datastore details.', () => {
