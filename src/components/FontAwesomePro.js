      ...
      case "facebook-circle":
        return (
          ...
          >
            ...
            <path
              fill="#FFF"
              d="M14.238 24v-6.621H12.02v-2.631h2.218v-2.073c0-2.252 1.376-3.479 3.386-3.479.963 0 1.79.072 2.029.104v2.354h-1.394c-1.093 0-1.303.521-1.303 1.281v1.813h2.466l-.338 2.631h-2.127V24"
            />
          </svg>
        );
      ...
      case "twitter-circle":
        return (
          ...
          >
            ...
            <path
              fill="#FFF"
              d="M21.939 12.954c.011.133.011.266.011.398 0 4.052-3.084 8.722-8.721 8.722a8.675 8.675 0 0 1-4.707-1.376c.247.028.484.038.741.038a6.137 6.137 0 0 0 3.805-1.31 3.07 3.07 0 0 1-2.866-2.126c.189.028.379.047.579.047.275 0 .55-.037.807-.104a3.064 3.064 0 0 1-2.458-3.008v-.039c.408.229.882.371 1.385.389a3.062 3.062 0 0 1-1.366-2.552c0-.569.151-1.091.417-1.546a8.715 8.715 0 0 0 6.32 3.207 3.407 3.407 0 0 1-.076-.702 3.064 3.064 0 0 1 3.065-3.065c.882 0 1.68.37 2.239.968a6.032 6.032 0 0 0 1.945-.74 3.057 3.057 0 0 1-1.347 1.689 6.12 6.12 0 0 0 1.765-.475 6.559 6.559 0 0 1-1.538 1.585z"
            />
          </svg>
        );
